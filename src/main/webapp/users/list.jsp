            ...
            <table class="table table-striped table-hover">
                ...
                <c:forEach var="user" items="${listUser}">
                    <tr>
                        ...
                        <td><c:out value="${user.classroom}"/></td>
                        <td>
                            <a href="/users?action=edit&id=${user.id}" class="edit" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                            <a href="/users?action=delete&id=${user.id}" class="delete" data-toggle="modal"><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                        </td>
                    </tr>
                </c:forEach>
